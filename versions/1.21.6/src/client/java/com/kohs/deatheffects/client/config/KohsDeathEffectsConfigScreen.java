...
public final class KohsDeathEffectsConfigScreen extends Screen {
	...
	private void drawPlayerSkin(
		...
		context.addPlayerSkin(model, texture, scale, pitch, yaw, verticalOffset, left, top, right, bottom);
	}
	...
	private PreviewPlayerEntity getPreviewPlayer() {
		...
		if (this.previewPlayer == null || this.previewPlayer.getWorld() != this.client.world) {
