...
public final class KohsDeathEffectsConfig {
	...
	public void sanitize() {
		...
		this.silhouetteAlpha = Mth.clamp(this.silhouetteAlpha, 0.05F, 1.0F);
		this.silhouetteScale = Mth.clamp(this.silhouetteScale, 0.5F, 2.5F);
		this.silhouetteDurationSeconds = Mth.clamp(this.silhouetteDurationSeconds, 1, 60);
		this.silhouetteRiseHeight = Mth.clamp(this.silhouetteRiseHeight, 0.5F, 64.0F);
		this.playerGhostAlpha = Mth.clamp(this.playerGhostAlpha, 0.05F, 1.0F);
		this.playerGhostDurationSeconds = Mth.clamp(this.playerGhostDurationSeconds, 1, 60);
		this.playerGhostRiseHeight = Mth.clamp(this.playerGhostRiseHeight, 0.5F, 64.0F);
		this.ragdollDurationSeconds = Mth.clamp(this.ragdollDurationSeconds, 1, 60);
		this.ragdollFadeDurationSeconds = Mth.clamp(this.ragdollFadeDurationSeconds, 5, 60);
		...
		this.faintCrawlSpeed = Mth.clamp(this.faintCrawlSpeed, 100, 300);
		if (this.kidsMode == null) {
			this.kidsMode = KidsMode.CUMULATIVE;
		}
		this.kidsTimerSeconds = Mth.clamp(this.kidsTimerSeconds, 3, 301);
		this.kidsCumulativeTimerSeconds = Mth.clamp(this.kidsCumulativeTimerSeconds, 20, 301);
		this.kidsRopeSizePercent = Mth.clamp(this.kidsRopeSizePercent, 100, 300);
		...
		this.morphAlpha = Mth.clamp(this.morphAlpha, 0.05F, 1.0F);
		this.morphElevationTimeSeconds = Mth.clamp(this.morphElevationTimeSeconds, 1, 60);
		this.morphMobSoundVolume = Mth.clamp(this.morphMobSoundVolume, 0, 300);
		this.morphMobSoundLoops = Mth.clamp(this.morphMobSoundLoops, 1, 3);
		...
		this.customDeathSoundVolume = Mth.clamp(this.customDeathSoundVolume, 0.0F, 3.0F);
	}
