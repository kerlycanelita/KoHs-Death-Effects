...
public final class KohsDeathEffectsClient implements ClientModInitializer {
	...
	public static void renderDeathEffects(MatrixStack matrices, VertexConsumerProvider consumers, OrderedRenderCommandQueue commandQueue, CameraRenderState cameraState) {
		DEATH_EFFECT_MANAGER.render(matrices, consumers, commandQueue, cameraState);
		KIDS_EFFECT_MANAGER.render(matrices, consumers, cameraState);
	}
